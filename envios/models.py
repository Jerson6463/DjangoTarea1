...
class Encomienda(models.Model):
    ...
    #Relaciones
    # Muchas Encomiendas tiene un remitente
    ...
    # Muchas Encomiendas tiene un destinatario
    ...
    def tiene_retraso(self):
        """Indica si la fecha estimada ya pasó y el paquete aún no se entrega[cite: 1048, 1049]."""
    ...
    def crear_con_costo_calculado(cls, remitente, destinatario, ruta, empleado, descripcion, peso_kg, **kwargs):
        ...
        import uuid
        # Generar código automático: ENC-YYYYMMDD-UUID
        codigo = f'ENC-{timezone.now().strftime("%Y%m%d")}-{str(uuid.uuid4())[:6].upper()}'
        
        # Calcular fecha estimada según la ruta
        ...
        # Asignar costo usando el método de instancia [cite: 1173]
